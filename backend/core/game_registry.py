...
_DEFAULT_PROJECTS: list[dict[str, Any]] = [
    ...
    {
        "id": "nte", "name": "異環", "subtitle": "成就紀錄器", "route": "/_projects/nte/index.html",
        "enabled": True, "iconEndpoint": "", "achievementPointLabel": "環石",
        "minimumCatalogCount": 380, "catalogFile": "data/catalogs/nte/achievements.json", "relationsDir": "data/relations/nte",
        "features": {"hiddenAchievements": True, "relations": True, "officialSync": True},
        "sourcePolicy": {
            "preserveFields": ["hidden", "category", "source_order", "raw"],
            "reviewOnConflict": True, "reviewOnRemoval": True, "protectProgress": True, "protectRelations": True,
            "primary": {"id": "nte_assets", "name": "Waifus-Grace/NTE_Assets", "url": "https://github.com/Waifus-Grace/NTE_Assets", "role": "primary", "mode": "remote_repository", "purpose": "official_catalog", "trustedFields": ["achievement_id", "name", "condition", "category", "reward", "hidden", "source_order", "version", "raw"]},
            "fallback": {"id": "verified_catalog_snapshot", "name": "目前正式目錄（僅供故障保護）", "url": "", "role": "fallback", "mode": "protected_snapshot", "automaticApply": False},
        },
    },
    {
